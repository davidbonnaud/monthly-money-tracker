# Generated by Django 3.2.1 on 2021-05-04 10:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14, validators=[djmoney.models.validators.MinMoneyValidator(0), djmoney.models.validators.MaxMoneyValidator(100000), djmoney.models.validators.MinMoneyValidator({'USD': 0}), djmoney.models.validators.MaxMoneyValidator({'USD': 100000})])),
                ('details', models.CharField(max_length=50)),
                ('date_time', models.DateTimeField(auto_now=True)),
                ('balance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='money.balance')),
            ],
        ),
    ]
